...
/**
 * @class SystemUtil
 * @brief 系统工具类，提供进程、线程和时间相关的静态方法。
 *
 * SystemUtil 封装了 POSIX 系统调用，用于获取进程/线程 ID、当前时间（毫秒和微秒）、线程睡眠等功能。
 ...
 * @endcode
 */
class SystemUtil : NoCopyable, NoMoveable {
  public:
    /**
     * @brief 获取当前进程 ID。
     * @return 进程 ID（PID）。
     ...
     */
    static void Sleep(int64_t second);
